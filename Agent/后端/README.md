...
这是 Agent 交付副本中的后端，配合 `Agent/前端/front` 和 `Agent/前端/front-mobile` 使用。
...
```powershell
..\后端\.venv\Scripts\python.exe .\run_report_task_check.py
..\后端\.venv\Scripts\python.exe .\check_report_quality.py
```
